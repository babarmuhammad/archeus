...
export const metadata: Metadata = {
  ...
  creator: SITE.author,
  /* The memory and workspace layer for AI coding agents — so the agent-level
     terms lead and the Claude Code ones follow. They used to be the whole list,
     which described the surface archeus drives rather than the thing it is. */
  keywords: [
