...
| `recall.py` (BM25, tokenisation, relation expansion, token budget, hits log) | REUSE WITH REFACTOR | scoring and rendering reused behind `infra/search/bm25.py`; input becomes knowledge rows | `context/`, `infra/search` |
