...
![Architecture graph](graph-real.webp){ width="820" height="474" loading=lazy }
...
The animation above is captured from the real HTML view (`docs/graph-real.webp`, regenerate
