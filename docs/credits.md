---
description: >-
  The projects and ideas archeus is built on — the Claude Code ecosystem work behind its
...
- **[anthropics/claude-code](https://github.com/anthropics/claude-code)** `code-review` plugin — the confidence-scoring + high-threshold + CLAUDE.md-compliance review pattern behind `archeus review`.
...
archeus itself is MIT licensed.
